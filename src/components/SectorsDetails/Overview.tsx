...
const SectorsDetailsOverview = React.memo(
  ({ overviewData, symbol, exchangeId }: any) => {
    ...
    return (
      <section id="overview" className={styles.overview}>
        ...
        <p className={styles.desc}>
          The sector has companies dealing with research, development and
          distribution of technology hardware and equipment. The companies
          primarily deal with the manufacturing of electronic goods and
