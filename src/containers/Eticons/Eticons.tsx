  ...
  return (
    <>
      ...
      <div className="clearfix mhl ptl">
        ...
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_ic_prime_square">
        ...
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_ic_sorting">
              <span className="path1"></span>
              <span className="path2"></span>
            </span>
        ...
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_icons_tables_add"></span>
            <span className={styles.mls}> eticon_icons_tables_add</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
        ...
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_icons_tables_edit"></span>
            <span className={styles.mls}> eticon_icons_tables_edit</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
