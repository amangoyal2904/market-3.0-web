import DeclaredResultsProfitLosersClient from "./client";
...
const DeclaredResultsProfitLosers = async (props: any) => {
  ...
  return (
    <>
      <DeclaredResultsProfitLosersClient
        data={upcoingData}
      ...
      <BreadCrumb
        ...
        pageName={[
          ...
          { label: "Profit-Losers", redirectUrl: "" },
        ]}
      />
      <br />
...
export default DeclaredResultsProfitLosers;
