...
import InvestEdgeTopVideo1 from "@/components/InvestEdgeTopVideo/InvestEdgeBox";
...
const InvestEdgeClient1 = ({ resultData, invementIdeaNavResult }: any) => {
                    ...
                    <SlickSlider
                      slides={item?.data
                        ...
                        .map((slide: any, index: any) => ({
                          content: (
                            <InvestEdgeTopVideo1 slide={slide} index={index} />
                          ),
                        }))}
                      key={`sliderNews`}
...
export default InvestEdgeClient1;
