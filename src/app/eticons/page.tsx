      ...
      <div className={styles.pageContainter}>
        ...
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            ...
            <span className={styles.mls}> eticon_bookmark</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
        ...
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            ...
            <span className={styles.mls}> eticon_caret_down</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_caret_left"></span>
            <span className={styles.mls}> eticon_caret_left</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_caret_right"></span>
            <span className={styles.mls}> eticon_caret_right</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_caret_up"></span>
            <span className={styles.mls}> eticon_caret_up</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
        ...
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_chevron_right"></span>
            <span className={styles.mls}> eticon_chevron_right</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
        ...
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_delete"></span>
            <span className={styles.mls}> eticon_delete</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
        ...
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_graph_chart"></span>
            <span className={styles.mls}> eticon_graph_chart</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_grid_view"></span>
            <span className={styles.mls}> eticon_grid_view</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
        ...
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_thumbs_down"></span>
            <span className={styles.mls}> eticon_thumbs_down</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
        ...
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            ...
            <span className={styles.mls}> eticon_user_profile</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_visible_eye"></span>
            <span className={styles.mls}> eticon_visible_eye</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
            <span className="eticon_visible_eye_off"></span>
            <span className={styles.mls}> eticon_visible_eye_off</span>
          </div>
        </div>
        <div className={styles.glyphLeft}>
          <div className={styles.container}>
